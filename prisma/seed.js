...
async function main() {
    ...
    const sizes = [
        {size_name: 'Small', price: 0.00},
        {size_name: 'Medium', price: 2.00},
        {size_name: 'Large', price: 4.00},
    ];

    const ingredients = [
        {ingredient_name: 'Pepperoni', price_adjustment: 1.50},
        {ingredient_name: 'Mushrooms', price_adjustment: 1.00},
        {ingredient_name: 'Extra Cheese', price_adjustment: 2.00},
    ];
    ...
    const pizzas = [
        {pizza_name: 'Margherita', base_price: 8.00},
        {pizza_name: 'Pepperoni Feast', base_price: 10.00},
        {pizza_name: 'Vegetarian', base_price: 9.00},
